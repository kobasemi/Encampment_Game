...
<form class="form1" action="./form/registerform.php" method="post">
  <h1>Create New Account</h1>
   <p>  &nbsp;&nbsp;&nbsp; E-mail   <input type="email" name="email" size="40" required/></p>
   <p>UserName<input type="text" name="username" size="40" required/></p>
   <p>PassWord <input type="password" name="password" size="40" required/></p></br>
<input class="btn"type="submit" name="submit" value="送る" />
</form>
